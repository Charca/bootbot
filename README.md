...
| Method signature |
|:-----------------|
| `chat.sendListTemplate(top_element_style, elements, buttons, [ options ])` |
| `convo.sendListTemplate(top_element_style, elements, buttons, [ options ])` |
| `bot.sendListTemplate(userId, top_element_style, elements, buttons, [ options ])` |
