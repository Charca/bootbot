...
class BootBot extends EventEmitter {
  ...
  say(recipientId, message, options) {
    ...
    else if(message && message.elements && message.buttons && message.options){ 
      return this.sendListTemplate(recipientId, message.elements, message.buttons, message.options);
    }
    else if(message && message.cards && message.options){ 
      return this.sendGenericTemplate(recipientId, message.cards, message.options);
    }
